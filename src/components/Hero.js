...
export default function Hero() {
    useEffect(() => {
        ...
        tl.from('#balloon-with-string', {duration: 2, x: 100, y: 100})
          .fromTo('#balloon', {x: -4.5, y: -4.5}, {duration: 2, x: 4.5, y: 4.5, fill: '#82b1ff', yoyo: true,repeat: -1})
    })
  return (
        ...
        <div className="col s7 valign-wrapper">
          <div className="headings">
            <Heading
              ...
              text="Happy Birthday Kym"
            />
            <AgeHeading classes="typewriter age light-green-text text-accent-3" text="Happy 24th" />
          </div>
        </div>
